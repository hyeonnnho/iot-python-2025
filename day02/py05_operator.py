...
print(greeting + target) # 문자열 연산 O, string concatenate : 연결하다.
...
print(listSample[9])
print(current[9])
print(listSample[-1]) # 인덱스 반대에서 가져오기(파이썬에서만 가능)
print(current[-1]) # 반대에서는 -1부터 시작
...
origin = '     Hello   ~     '
print(f'//{origin}//')
print(f'//{origin.lstrip()}//') # 좌측공백 제거
print(f'//{origin.rstrip()}//') # 우측공백 제거
print(f'//{origin.strip()}//') # 공백 제거
...
print(full_name.index('o')) # index는 순서
