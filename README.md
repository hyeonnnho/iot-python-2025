...
- 파이썬 기초
    ...
    - 모듈, 패키지
        - 모듈 : 함수나 클래스 등 자주 사용할 것을 파이썬 파일로 만든 것
...
- 파이썬 응용
    - 토이프로젝트
        - 내 영화 앱 수정, 마무리
            - 예외처리 : 입력 시 바로 엔터, 입력 시 4개의 아이템을 입력하지 않은 경우, 
            - 화면편집 : 검색이나 출력 시 데이터 수 표시
              

https://github.com/user-attachments/assets/6ff11b64-aa51-4e52-826a-4308b3bcff69
...
- 파이썬 응용
    ...
    - 파이썬 GUI 라이브러리
        1. PyQt, PySide : 파이썬 최고의 GUI 라이브러리. Qt라는 C/C++ 사용할 GUI 라이브러리르 Python용으로 변경
            - 화려한 UI 구성
            - 코딩 다양성
            - 다소 어려움(파이썬 코드와 분리 가능)
            - Qt: 라이선스를 구매 필수, PySide: 프리웨어로 변경
...
- 파이썬 응용
    ...
    - 토이프로젝트
        ...
        - 공의 시작 방향, 경계부분 문제해결, 종료 후 다시 시작 로직
